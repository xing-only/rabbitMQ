...
public class AutoListener implements ChannelAwareMessageListener{
    ...
    public void onMessage(Message message, Channel channel) throws Exception {
        try {
            ...
            System.out.println("消费者一号  绑定的 q_spring_xing_1 队列 获取的信息：" + jsonData.toString());
            System.out.println("消费者一号绑定的队列" + message.getMessageProperties().getConsumerQueue());
